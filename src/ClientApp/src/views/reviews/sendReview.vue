...
<template>
  <HelpButton>
    ...
    <p>
      <h5 class="mt-6 mb-3 bg-gray-100 p-2 rounded"><i class="bi bi-asterisk px-2"></i> Processo de Classificação Técnica</h5>
    ...
    <p>
    <h5 class="mt-6 mb-3 bg-gray-100 p-2 rounded"><i class="bi bi-database-fill-gear px-2"></i>Armazenamento Temporário</h5>
  ...
  <div class="d-flex flex-column flex-lg-row justify-content-center align-items-stretch bg-light px-3 pt-3 pt-lg-0">

    <!-- Título (Mobile) -->
    <div class="d-flex d-lg-none align-items-center bg-purple text-white rounded shadow-sm p-4 mb-3 w-100" style="max-width: 500px;">
    ...
    <!-- Formulário -->
    <div class="position-relative bg-white rounded shadow-sm d-flex flex-column justify-content-center align-items-center w-100 px-3 py-4 py-lg-5 m-0 m-lg-2" style="max-width: 100%;">
