...
<template>
  <div class="d-flex flex-column justify-content-center h-100">
    <HelpButton>
      ...
      <p>
      <h5 class="mt-6 mb-3 bg-gray-100 p-2 rounded"><i class="bi bi-asterisk px-2"></i> Como Funciona o Pré-Pedido por
        Imagem</h5>
      O processo se inicia quando o usuário envia uma imagem por meio de um <strong>POST ao backend</strong>. A imagem é
      analisada utilizando o serviço <strong>Azure Document
      ...
      <ul>
        <li>
          <a href="https://azure.microsoft.com/pt-br/products/ai-services/ai-document-intelligence" target="_blank"
            rel="noopener">
            Azure AI Document Intelligence – Visão Geral
          </a>
        </li>
        <li>
          <a href="https://www.youtube.com/watch?v=CgFblpWJ8lU&t" target="_blank" rel="noopener">
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-center align-items-stretch px-3 pt-3 pt-lg-0">
      ...
      <!-- Título (Mobile) -->
      <div class="d-flex d-lg-none align-items-center bg-purple text-white rounded p-4 mb-3" style="width: 100%;">
        ...
        <div class="w-100" style="max-width: 500px;">
          ...
          <div class="card shadow-none border border-2 border-dashed position-relative mb-4"
            ...
            <label for="file-upload"
              ...
              <input type="file" id="file-upload" class="visually-hidden" accept="image/png, image/jpeg"
