...
const welcomeMessage = '👋 Olá! eu sou o assistente virtual de pedidos. Como posso ajudar você hoje?';
...
async function createAgentAndThread() {
  ...
  const agentRes = await axios.post('/api/agents', { Type: 2 });
...
<template>
  <div class="d-flex flex-column p-3" style="height: 95vh;">
    <h3 class="mb-3">Assistente de informação sobre os pedidos dos clientes</h3>
    ...
    <div class="d-flex">
      ...
      <button class="btn btn-secondary me-2" @click="resetThread" :disabled="isLoading">Reset</button>
