            ...
            <div class="list-group list-group-borderless gap-2 list-group-flush">
              <div data-size-value="1" @click="handleSizeClick" class="list-group-item">
                <div class="d-flex align-items-center">
                  <div class="me-4">
                    <div :class="['icon icon-shape text-lg text-primary', selectedSize === 1 ? 'border-purple bg-dark-subtle' : 'bg-body-secondary']">
              ...
              <div data-size-value="2" @click="handleSizeClick" class="list-group-item">
                <div class="d-flex align-items-center">
                  <div class="me-4">
                    <div :class="['icon icon-shape text-lg text-primary', selectedSize === 2 ? 'border-purple bg-dark-subtle' : 'bg-body-secondary']">
              ...
              <div data-size-value="3" @click="handleSizeClick" class="list-group-item">
                <div class="d-flex align-items-center">
                  <div class="me-4">
                    <div :class="['icon icon-shape text-lg text-primary', selectedSize === 3 ? 'border-purple bg-dark-subtle' : 'bg-body-secondary']">
              ...
              <div class="list-group-item">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-fill">
                    <span class="d-block h6 fw-semibold mb-1">Cada
                      adicional</span>
                  </div>
                  <div class="ms-auto text-end">
